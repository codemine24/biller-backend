...
export const OTPTemplate = (otp: string, appInfo: any | null) => {
  // TODO: change appInfo type
  return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto;">
            ...
            <td style="padding: 20px 0; text-align: center; background-color: #4f46e5;">
                ...
                }/storage/v1/object/public/assets/${appInfo?.logo}" alt="${
    config.app_name
            ...
            <td style="background-color: #f4f4f4; padding: 20px 30px;">
                ...
                <tr>
                    ...
                    <p style="margin: 0;">${
                      appInfo?.address || config.app_address
                    }</p>
                    </td>
                </tr>
                <tr>
